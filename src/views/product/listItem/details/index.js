...
class DetailProducts extends Component {
  ...
  render() {
    ...
    const { count, activeTab, cartLength, loading, data, inside, properties, setSelectedValue ,listItem} = this.state;
          ...
          <ScrollView>
            ...
            {status === "" || authUser.GROUPS == 8 ? <View>
              ...
              <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                <TouchableOpacity
                  onPress={()=>this.shareContent(data)}
                  style={{
              ...
              //             this.onShare();
              //           }}
              //           style={{ backgroundColor: '#4a8939', width: sizeWidth(35), borderRadius: 5, padding: 7 }}
              //         >
